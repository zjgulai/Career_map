---
name: SKILL
trigger: skill, channel, operate/ka, sell, throug
...
> SKILL 是一个专业的 当需要解读 KA 门店 POS 或零售商报表、识别动销慢的原因并给出可执行改善建议时调用；输出供补货、陈列与谈判使用。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, channel, operate/ka, sell, throug
```
