...
title: "加权评分决策"
user_summary: "几个方案选一个，用加权打分和敏感性分析把理由说清楚"
user_try: "帮我比较这三家供应商，按价格、交期、质量加权打分"
description: "引导完成候选方案、评估维度、权重分配、逐项评分与敏感性分析的多准则决策矩阵。触发词：选哪个方案、加权评分、方案对比、技术选型、决策矩阵、weighted-scoring。何时不用：只有两个选项且差异明显时不必套矩阵；核查已有分析结论是否可信用 validate-data。"
enabled: "true"
user-invocable: true
metadata:
  source: "third-party"
  batch: "kimi"
  license: "MIT"
  sha256: "ba8a52c85d0940e28409a1e981395d22ec58700fa3f6eddea14f2c82526e1a08"
