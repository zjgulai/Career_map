...
trigger: remember, 记住, save this, 长期记忆, 记忆保存, 知识固化
description: 快速长期记忆保存
...
> hermes-remember 是一个专业的 快速长期记忆保存，帮助用户快速完成相关任务并输出标准化交付物。
...
```
remember, 记住, save this, 长期记忆, 记忆保存, 知识固化
```
...
hermes-remember 属于 **开发运维** 域（development and DevOps for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 hermes-remember 帮我下一步行动或相关skill推荐...
```
