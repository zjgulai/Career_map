---
name: SKILL
trigger: skill, product, manage/sku, lifecycle, c
...
> SKILL 是一个专业的 当已有销量时间序列或周度销量斜率、需将 SKU 标注为导入/成长/成熟/衰退以驱动归因或退场策略时调用；依赖 ERP 或报表数据。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, product, manage/sku, lifecycle, c
```
