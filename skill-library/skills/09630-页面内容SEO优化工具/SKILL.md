---
name: SEO Content Optimizer - 页面内容SEO优化工具
trigger: seo, content, optimizer, , , 页面内容seo优化工具
description: 提供关键词密度分析、内容质量评估、Title/Meta优化、内部链接策略等页面级优化建议。
category: lute_cbec
version: 2.1.0
author: hermes-ai
...
> SEO Content Optimizer - 页面内容SEO优化工具 是一个专业的 提供关键词密度分析、内容质量评估、Title/Meta优化、内部链接策略等页面级优化建议。，帮助用户快速完成相关任务并输出标准化交付物。
...
SEO Content Optimizer - 页面内容SEO优化工具 属于 **搜索优化** 域（SEO/GEO optimization for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 SEO Content Optimizer - 页面内容SEO优化工具 帮我下一步行动或相关skill推荐...
```
...
```mermaid
graph LR
    A[用户输入] -->|触发词| B(SEO Content Optimizer - 页面内容SEO优化工具)
    B --> C[分析结果]
    B --> D[解决方案]
```
