...
After delivery, **ask the user:** _"Would you like to export this presentation as a PDF?"_
...
If the user declines, stop here. If they choose to export, proceed below.
