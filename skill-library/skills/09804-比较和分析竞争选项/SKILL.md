...
name: 比较和分析竞争选项
trigger: 比较和分析竞争选项
description: 来源：https://claude.com/resources/use-cases/compare-and-analyze-competing-options
...
> 比较和分析竞争选项 是一个专业的 来源：https://claude.com/resources/use-cases/compare-and-analyze-competing-options，帮助用户快速完成相关任务并输出标准化交付物。
...
比较和分析竞争选项 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 比较和分析竞争选项 帮我下一步行动或相关skill推荐...
```
