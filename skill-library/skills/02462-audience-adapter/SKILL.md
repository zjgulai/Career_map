...
title: "汇报口径适配"
user_summary: "同一件事，对 CEO 和对技术团队说成两个版本"
user_try: "把这次技术变更同步给 CEO，压到一页只留结论"
description: "按受众（CEO、VP、技术负责人、运营）调整同一件事的信息粒度与语言，产出邮件或汇报要点。触发词：向上汇报、给老板写邮件、跨部门同步、汇报材料、对齐口径、audience-adapter。何时不用：把一段时间的工作汇总成周期汇报用 work-report-writer；会议过程记录用 meeting-minutes。"
enabled: "true"
user-invocable: true
metadata:
  source: "third-party"
  batch: "kimi"
  license: "MIT"
  sha256: "47f9c57bfb496e34dadea79ad1f45c439ccb30c28fbda108ba888a8e67326322"
