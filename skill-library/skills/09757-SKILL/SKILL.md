---
name: SKILL
trigger: skill, customer, care, support/review, r
...
> SKILL 是一个专业的 当需回复亚马逊/独立站/社媒上的公开评价、尤其是差评时调用；区分北美与欧洲语气，并避免引发法律与平台二次违规。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, customer, care, support/review, r
```
