---
name: Lute Skills Eval
trigger: lute, skills, eval
description: `lute-skills-eval` 是一个用于评估 Skill 质量的工具 Skill。基于 Universal Skill Schema v1.1.0 对给定的 Skill 进行**六维度深度评估
category: lute_cbec
version: 2.1.0
author: hermes-ai
...
> Lute Skills Eval 是一个专业的 `lute-skills-eval` 是一个用于评估 Skill 质量的工具 Skill。基于 Universal Skill Schema v1.1.0 对给定的 Skill 进行**六维度深度评估，帮助用户快速完成相关任务并输出标准化交付物。
...
Lute Skills Eval 属于 **通用** 域（general-purpose for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 Lute Skills Eval 帮我下一步行动或相关skill推荐...
```
