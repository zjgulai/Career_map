---
name: 在对话中绘制文献综述地图，揭示潜在争议
trigger: 在对话中绘制文献综述地图，揭示潜在争议
description: **摘要**：本文介绍如何在 Claude 对话中上传一组论文，让 Claude 绘制出学术争议的论辩结构图——按主张聚类、标出不同阵营之间的张力线、指出每派的盲区。这张地图是你对文献整体图景的一次解
...
> 在对话中绘制文献综述地图，揭示潜在争议 是一个专业的 **摘要**：本文介绍如何在 Claude 对话中上传一组论文，让 Claude 绘制出学术争议的论辩结构图——按主张聚类、标出不同阵营之间的张力线、指出每派的盲区。这张地图是你对文献整体图景的一次解，帮助用户快速完成相关任务并输出标准化交付物。
...
在对话中绘制文献综述地图，揭示潜在争议 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 在对话中绘制文献综述地图，揭示潜在争议 帮我下一步行动或相关skill推荐...
```
...
```mermaid
graph LR
    A[用户输入] -->|触发词| B(在对话中绘制文献综述地图，揭示潜在争议)
    B --> C[分析结果]
    B --> D[解决方案]
```
