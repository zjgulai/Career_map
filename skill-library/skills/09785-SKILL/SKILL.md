---
name: SKILL
trigger: skill, channel, operate/ka, planogram, c
...
> SKILL 是一个专业的 当需要按零售商 planogram 或品类协议、检查门店实拍/巡检表是否满足陈列面位、价签、认证贴标与竞品对比时调用；输出整改清单与照片要求。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, channel, operate/ka, planogram, c
```
