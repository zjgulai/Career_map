---
name: perf-optimizer
trigger: perf, 性能优化, 瓶颈分析, 火焰图, 内存优化, 速度提升
description: 性能瓶颈分析与优化
category: dev
version: 2.1.0
author: hermes-ai
...
> perf-optimizer 是一个专业的 性能瓶颈分析与优化，帮助用户快速完成相关任务并输出标准化交付物。
...
perf-optimizer 属于 **开发运维** 域（development and DevOps for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 perf-optimizer 帮我下一步行动或相关skill推荐...
```
