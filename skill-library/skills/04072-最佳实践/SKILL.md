...
description: "按主题索引 PostgreSQL 的 schema 设计、索引优化、MVCC/VACUUM、WAL、复制、备份恢复与 PgBouncer 配置参考。触发词：PostgreSQL 运维调优、postgres、按主题索引 PostgreSQL 的 schema 设计、索引优化、MVCC/VACUUM、WAL、复制、备份恢复与 PgBouncer 配置参考。"
enabled: "true"
