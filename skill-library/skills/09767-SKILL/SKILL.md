---
name: SKILL
trigger: skill, marketing, promote/influencer, b
...
> SKILL 是一个专业的 当需要向达人交付标准化合作 Brief（产品使用要点、必须口播的合规声明、禁止场景与素材授权）且已有信任型内容框架时调用；不替代合同与付款条款。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, marketing, promote/influencer, b
```
