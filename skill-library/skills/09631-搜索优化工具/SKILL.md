---
name: SEO GEO Optimizer - GEO/AI搜索优化工具
trigger: seo, geo, optimizer, , , geo, ai搜索优化工具
description: 提供AI搜索结果占位、Product Schema优化、AI Shopping可见性提升、结构化数据生成等AI时代SEO方案。
category: lute_cbec
version: 2.1.0
author: hermes-ai
...
> SEO GEO Optimizer - GEO/AI搜索优化工具 是一个专业的 提供AI搜索结果占位、Product Schema优化、AI Shopping可见性提升、结构化数据生成等AI时代SEO方案。，帮助用户快速完成相关任务并输出标准化交付物。
...
SEO GEO Optimizer - GEO/AI搜索优化工具 属于 **搜索优化** 域（SEO/GEO optimization for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 SEO GEO Optimizer - GEO/AI搜索优化工具 帮我下一步行动或相关skill推荐...
```
...
```mermaid
graph LR
    A[用户输入] -->|触发词| B(SEO GEO Optimizer - GEO/AI搜索优化工具)
    B --> C[分析结果]
    B --> D[解决方案]
```
