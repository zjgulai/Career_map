...
title: "技术文档与图表写作"
user_summary: "写 Markdown 文档时随手把关系画成可 diff 的图"
user_try: "把这份方案写成 md，用 Mermaid 画个数据流转图"
description: "用 Markdown 加内嵌 Mermaid 图写文档，含 24 种图型指引、9 套模板与统一排版规范。触发词：写文档、画流程图、加个架构图、Markdown 排版、关系图、markdown-mermaid-writing。何时不用：要导出栅格图片（PNG/SVG）时用 chart-gen；做网页演示用 guizang-ppt-skill。"
enabled: "true"
user-invocable: true
metadata:
  source: "third-party"
  batch: "manus"
  license: "Apache-2.0"
  sha256: "801fabc81393c8467f13ed705940468b95c3e61fdad33cb7cca7550cc7c99900"
