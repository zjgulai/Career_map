---
name: SKILL
trigger: skill, channel, operate/listing, bulk, g
...
> SKILL 是一个专业的 当有关键词矩阵与合规通过的文案约束、且需从 ERP 批量生成亚马逊/TikTok/Shopify 上架草稿时调用；生成前须满足 listing-compliance-scanner PASS。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, channel, operate/listing, bulk, g
```
