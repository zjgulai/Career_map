---
name: SKILL
trigger: skill, channel, operate/regulatory, upd
...
> SKILL 是一个专业的 当需要定期汇总 FDA、EU MDR/CPSC 等公开更新线索、生成「影响 SKU/证书」初筛表并触发缺口重评与日历时调用；不替代订阅服务与律师解读。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, channel, operate/regulatory, upd
```
