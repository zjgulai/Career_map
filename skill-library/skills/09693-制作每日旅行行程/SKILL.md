...
name: 制作每日旅行行程
trigger: 制作每日旅行行程
description: 来源：https://claude.com/resources/use-cases/create-a-daily-travel-itinerary
...
> 制作每日旅行行程 是一个专业的 来源：https://claude.com/resources/use-cases/create-a-daily-travel-itinerary，帮助用户快速完成相关任务并输出标准化交付物。
...
制作每日旅行行程 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
