...
title: "提示词工程"
description: "设计、优化与评测 LLM 提示词：选对模式、写系统提示词与护栏、搭结构化输出 schema，并用测试集与指标衡量效果。触发词：提示词工程、prompt-engineer、设计、优化与评测 LLM 提示词：选对模式、写系统提示词与护栏、搭结构化输出 schema，并用测试集与指标衡量效果。"
enabled: "true"
