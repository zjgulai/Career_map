...
When using this skill with CodeBuddy Code, CodeBuddy can directly analyze waveform plots and provide expert curation decisions. For programmatic API access:
...
**CodeBuddy Code Integration**: When running within CodeBuddy Code, ask CodeBuddy to examine waveform/correlogram plots directly - no API setup required.
