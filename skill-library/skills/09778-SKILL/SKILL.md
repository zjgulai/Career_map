---
name: SKILL
trigger: skill, customer, care, support/customer
...
> SKILL 是一个专业的 当需要把客服输入按风险与诉求类型分流到退货判定、差评回复或安全升级流程时调用。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, customer, care, support/customer
```
