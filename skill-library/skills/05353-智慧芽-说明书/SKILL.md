...
- **业务工具名**：`/zhihuiya/descriptionData`
- **所属分组**：智慧芽 · 专利数据
- **功能说明**：工具中文名：智慧芽-说明书
...
当用户意图与“智慧芽-说明书”匹配，或需要以下能力时使用本工具：工具中文名：智慧芽-说明书
描述：可以通过输入专利ID或专利公开号查询具体某条专利的说明书信息。
关键词：智慧芽,说明
...
| `replaceByRelated` | `string` | 否 | 最长 1000 | 当前专利说明书无法获取时是否用同族专利的说明书替代：1是 0否 |
...
| `description` | `array<object>` | 否 |  | 说明书 |
