...
name: 将灵感转化为设计方案
trigger: 将灵感转化为设计方案
description: 来源：https://claude.com/resources/use-cases/turn-inspiration-to-design-plans
...
> 将灵感转化为设计方案 是一个专业的 来源：https://claude.com/resources/use-cases/turn-inspiration-to-design-plans，帮助用户快速完成相关任务并输出标准化交付物。
...
将灵感转化为设计方案 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 将灵感转化为设计方案 帮我下一步行动或相关skill推荐...
```
