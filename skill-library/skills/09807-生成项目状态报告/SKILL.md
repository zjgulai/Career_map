...
name: 生成项目状态报告
trigger: 生成项目状态报告
description: 来源：https://claude.com/resources/use-cases/generate-project-status-reports
...
> 生成项目状态报告 是一个专业的 来源：https://claude.com/resources/use-cases/generate-project-status-reports，帮助用户快速完成相关任务并输出标准化交付物。
...
生成项目状态报告 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
