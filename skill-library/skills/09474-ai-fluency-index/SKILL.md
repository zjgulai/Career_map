...
trigger: fluency index, 流畅度指数, AI评估, 会话质量, 交互评分
description: AI会话流畅度评估
category: ai
version: 2.1.0
author: hermes-ai
...
> ai-fluency-index 是一个专业的 AI会话流畅度评估，帮助用户快速完成相关任务并输出标准化交付物。
...
```
fluency index, 流畅度指数, AI评估, 会话质量, 交互评分
```
...
ai-fluency-index 属于 **开发运维** 域（development and DevOps for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 ai-fluency-index 帮我下一步行动或相关skill推荐...
```
