---
name: ecom-main-hub
trigger: ecom, main, hub
description: 电商数据分析技能包主协调器，整合日报/周报、月度复盘、季度战略、大促分析、CSV处理等电商数据技能。
category: lute_cbec
version: 2.1.0
author: hermes-ai
...
> ecom-main-hub 是一个专业的 电商数据分析技能包主协调器，整合日报/周报、月度复盘、季度战略、大促分析、CSV处理等电商数据技能。，帮助用户快速完成相关任务并输出标准化交付物。
...
ecom-main-hub 属于 **电商运营** 域（e-commerce operations for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 ecom-main-hub 帮我下一步行动或相关skill推荐...
```
