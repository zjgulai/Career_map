...
name: 基于日历进行准备和规划
trigger: 基于日历进行准备和规划
description: 来源：https://claude.com/resources/use-cases/prepare-and-plan-from-your-calendar
...
> 基于日历进行准备和规划 是一个专业的 来源：https://claude.com/resources/use-cases/prepare-and-plan-from-your-calendar，帮助用户快速完成相关任务并输出标准化交付物。
...
基于日历进行准备和规划 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 基于日历进行准备和规划 帮我下一步行动或相关skill推荐...
```
