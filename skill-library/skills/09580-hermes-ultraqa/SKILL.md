---
name: hermes-ultraqa
trigger: ultraqa, QA, 跑测试, test, 质量循环, 测试驱动, 质量门禁
description: QA质量循环
category: dev
version: 2.1.0
author: hermes-ai
...
> hermes-ultraqa 是一个专业的 QA质量循环，帮助用户快速完成相关任务并输出标准化交付物。
...
```
ultraqa, QA, 跑测试, test, 质量循环, 测试驱动, 质量门禁
```
...
hermes-ultraqa 属于 **开发运维** 域（development and DevOps for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 hermes-ultraqa 帮我下一步行动或相关skill推荐...
```
