---
name: SKILL
trigger: skill, marketing, promote/campaign, per
...
> SKILL 是一个专业的 当广告花费波动、转化下滑或复盘周期到达时，输出渠道与素材分层效率以及预算调整建议。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, marketing, promote/campaign, per
```
