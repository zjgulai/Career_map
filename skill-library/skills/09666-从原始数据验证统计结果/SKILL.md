...
name: 从原始数据验证统计结果
trigger: 从原始数据验证统计结果
description: 来源：https://claude.com/resources/use-cases/verify-statistics-from-raw-data
...
> 从原始数据验证统计结果 是一个专业的 来源：https://claude.com/resources/use-cases/verify-statistics-from-raw-data，帮助用户快速完成相关任务并输出标准化交付物。
...
从原始数据验证统计结果 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 从原始数据验证统计结果 帮我下一步行动或相关skill推荐...
```
