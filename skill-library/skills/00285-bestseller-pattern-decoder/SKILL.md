...
workflow: |
  Complete this in four steps:
    ...
    2. Pricing Logic Audit (find the pricing sweet spot with highest sales concentration)
    3. Visual & Video Strategy Analysis (main image, video hooks, graphic overlays)
    4. Copywriting & Narrative Logic (title keyword structure, A+ content storytelling)
enabled: true
---

# Bestseller Pattern Decoder
...
### Step 1: Identifying the "Model" Sellers
...
- Identify which features are universally included at the sweet spot and what justifies premium pricing

---

### Step 3: Visual & Video Strategy Analysis
...
### Step 4: Copywriting & Narrative Logic
...
### 1. Best Seller Success Blueprint
...
### 3. Listing Optimization Roadmap
