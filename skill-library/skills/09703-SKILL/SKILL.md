---
name: SKILL
trigger: skill, channel, operate/multilingual, l
...
> SKILL 是一个专业的 在买手提案中文案已定稿后，将执行摘要、条款说明、邮件沟通稿转为目标市场商务用语（英式/美式、德语、法语等），保持数字与法律含义不变；不替代法律翻译。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, channel, operate/multilingual, l
```
