...
description: >-
  Build keyword-optimized Amazon listings (title, bullets, backend search terms) from search-volume data; off-Amazon copy reuses buyer language only. Use for listing copywriting or keyword targeting.
metadata:
  version: "1.0.0"
---
