---
name: SKILL
trigger: skill, supply, chain, fulfill/fba, capac
...
> SKILL 是一个专业的 当建议补货量与物流方案需要适配 FBA 容量限制、分仓入库与入库配置费时调用；北美/欧洲规则分轨。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, supply, chain, fulfill/fba, capac
```
