---
name: SEO Competitor Analyzer - 竞品SEO分析工具
trigger: seo, competitor, analyzer, , , 竞品seo分析工具
description: 提供竞品页面抓取、SEO策略对比、关键词差距分析、反向链接洞察等竞争情报。
category: lute_cbec
version: 2.1.0
author: hermes-ai
...
> SEO Competitor Analyzer - 竞品SEO分析工具 是一个专业的 提供竞品页面抓取、SEO策略对比、关键词差距分析、反向链接洞察等竞争情报。，帮助用户快速完成相关任务并输出标准化交付物。
...
SEO Competitor Analyzer - 竞品SEO分析工具 属于 **搜索优化** 域（SEO/GEO optimization for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 SEO Competitor Analyzer - 竞品SEO分析工具 帮我下一步行动或相关skill推荐...
```
...
```mermaid
graph LR
    A[用户输入] -->|触发词| B(SEO Competitor Analyzer - 竞品SEO分析工具)
    B --> C[分析结果]
    B --> D[解决方案]
```
