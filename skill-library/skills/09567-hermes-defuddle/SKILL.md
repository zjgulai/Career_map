---
name: hermes-defuddle
trigger: defuddle, 网页清洗, 提取内容, 去广告, 结构化提取, 内容清洗
description: 网页内容提取清洗
category: tool
version: 2.1.0
author: hermes-ai
...
> hermes-defuddle 是一个专业的 网页内容提取清洗，帮助用户快速完成相关任务并输出标准化交付物。
...
```
defuddle, 网页清洗, 提取内容, 去广告, 结构化提取, 内容清洗
```
...
hermes-defuddle 属于 **开发运维** 域（development and DevOps for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 hermes-defuddle 帮我下一步行动或相关skill推荐...
```
