...
title: "会议纪要"
user_summary: "开完会把转写丢进来，直接得到决议和带负责人的行动项"
user_try: "把这段周会转写整理成纪要，列出行动项和负责人"
description: "把会议转写或零散笔记整理成含决议、行动项、负责人与截止日的结构化纪要。触发词：会议纪要、整理会议记录、行动项、开会记录、会议总结、meeting-minutes。何时不用：只做纯语音转写而不整理成文档时不用；把一段时间的工作汇总成周期汇报用 work-report-writer。"
enabled: "true"
user-invocable: true
metadata:
  source: "third-party"
  ...
  sha256: "69420bbe78b2f6c81f9689672360dd97e71e9fc83045a70e3d6924f24973a789"
