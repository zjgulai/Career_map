---
id: SKL-severity-SEVERITYLEVELS
name: Severity Levels
description: Severity levels provide a standardized way to classify incidents based
  on their impact, enabling appropriate response, resource allocation, and communication.
  Consistent severity classification ensure
version: 1.0.0
status: active
owner: '@cerebra-team'
