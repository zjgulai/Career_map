---
name: SKILL
trigger: skill, finance, cost, management/ka, ar,
...
> SKILL 是一个专业的 当需按 KA 客户/发票维度跟踪应收、账期、逾期与对账差异时调用；输出供战略（含财务）与渠道对买手/财务结算；不替代会计记账。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, finance, cost, management/ka, ar,
```
