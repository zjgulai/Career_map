...
description: "用 LangChain 与 LangGraph 搭建 LLM 应用：状态图、对话记忆、工具集成与测试策略全流程。触发词：LangChain 架构设计、langchain-architecture、用 LangChain 与 LangGraph 搭建 LLM 应用：状态图、对话记忆、工具集成与测试策略全流程。"
enabled: "true"
...
pc = Pinecone([REDACTED]"PINECONE_API_KEY"])
