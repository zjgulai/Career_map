...
trigger: brainstorming, 头脑风暴, 想个方案, 创意发散, ideation, 方案探索
description: AI辅助头脑风暴
category: creative
version: 2.1.0
author: hermes-ai
...
> hermes-brainstorming 是一个专业的 AI辅助头脑风暴，帮助用户快速完成相关任务并输出标准化交付物。
...
```
brainstorming, 头脑风暴, 想个方案, 创意发散, ideation, 方案探索
```
...
hermes-brainstorming 属于 **开发运维** 域（development and DevOps for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 hermes-brainstorming 帮我下一步行动或相关skill推荐...
```
...
```mermaid
graph LR
    A[用户输入] -->|触发词| B(hermes-brainstorming)
    B --> C[分析结果]
    B --> D[解决方案]
```
