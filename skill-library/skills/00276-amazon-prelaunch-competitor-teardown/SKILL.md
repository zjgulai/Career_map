...
description: >-
  Tear down a competing Amazon ASIN or brand: revenue, price history, keyword footprint, share of voice, and where it is weak. Use when the user shares a competitor ASIN or brand to beat.
metadata:
  version: "1.0.0"
---
...
call them directly and do the analysis yourself. There are no API keys, scripts,
or rate limits to manage in this skill. Do **not** substitute any other
