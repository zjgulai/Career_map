---
name: SKILL
trigger: skill, customer, care, support/safety, f
...
> SKILL 是一个专业的 当客服文本中出现人身伤害风险、产品安全、婴儿健康相关描述时调用；输出「升级人工」结论，禁止进入自动回复闭环。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, customer, care, support/safety, f
```
