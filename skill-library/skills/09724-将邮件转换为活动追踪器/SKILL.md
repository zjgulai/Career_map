...
name: 将邮件转换为活动追踪器
trigger: 将邮件转换为活动追踪器
description: 来源：https://claude.com/resources/use-cases/turn-emails-into-an-event-tracker
...
> 将邮件转换为活动追踪器 是一个专业的 来源：https://claude.com/resources/use-cases/turn-emails-into-an-event-tracker，帮助用户快速完成相关任务并输出标准化交付物。
...
将邮件转换为活动追踪器 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 将邮件转换为活动追踪器 帮我下一步行动或相关skill推荐...
```
