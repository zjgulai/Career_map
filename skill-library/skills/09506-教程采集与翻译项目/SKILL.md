---
name: Claude 教程采集与翻译项目
trigger: claude, 教程采集与翻译项目
description: 本项目通过浏览器自动化采集了 Claude 官方教程页面的所有文章，并按照页面左侧分类整理保存。
...
> Claude 教程采集与翻译项目 是一个专业的 本项目通过浏览器自动化采集了 Claude 官方教程页面的所有文章，并按照页面左侧分类整理保存。，帮助用户快速完成相关任务并输出标准化交付物。
...
Claude 教程采集与翻译项目 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 Claude 教程采集与翻译项目 帮我下一步行动或相关skill推荐...
```
