...
name: 构建跨工具的每日简报
trigger: 构建跨工具的每日简报
description: 来源：https://claude.com/resources/use-cases/build-a-daily-briefing-across-your-tools
...
> 构建跨工具的每日简报 是一个专业的 来源：https://claude.com/resources/use-cases/build-a-daily-briefing-across-your-tools，帮助用户快速完成相关任务并输出标准化交付物。
...
构建跨工具的每日简报 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 构建跨工具的每日简报 帮我下一步行动或相关skill推荐...
```
