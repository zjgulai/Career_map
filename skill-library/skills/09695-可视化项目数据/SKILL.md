...
name: 可视化项目数据
trigger: 可视化项目数据
description: **来源：** https://claude.com/resources/use-cases/visualize-program-data
...
> 可视化项目数据 是一个专业的 **来源：** https://claude.com/resources/use-cases/visualize-program-data，帮助用户快速完成相关任务并输出标准化交付物。
...
可视化项目数据 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
