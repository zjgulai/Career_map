---
name: SEO Main Hub - SEO与GEO优化主协调器
trigger: seo, main, hub, , , seo与geo优化主协调器
description: 整合技术SEO审计、内容优化、竞品分析、多语言SEO、AI搜索优化五大模块。
category: lute_cbec
version: 2.1.0
author: hermes-ai
...
> SEO Main Hub - SEO与GEO优化主协调器 是一个专业的 整合技术SEO审计、内容优化、竞品分析、多语言SEO、AI搜索优化五大模块。，帮助用户快速完成相关任务并输出标准化交付物。
...
SEO Main Hub - SEO与GEO优化主协调器 属于 **搜索优化** 域（SEO/GEO optimization for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 SEO Main Hub - SEO与GEO优化主协调器 帮我下一步行动或相关skill推荐...
```
...
```mermaid
graph LR
    A[用户输入] -->|触发词| B(SEO Main Hub - SEO与GEO优化主协调器)
    B --> C[分析结果]
    B --> D[解决方案]
```
