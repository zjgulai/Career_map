---
name: SKILL
trigger: skill, product, manage/sku, exit, decisi
...
> SKILL 是一个专业的 当 SKU 为 C 级危险或生命周期衰退且归因后仍无改善路径、需输出可执行的退场方案与时间表时调用；重大财务影响需战略侧确认。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, product, manage/sku, exit, decisi
```
