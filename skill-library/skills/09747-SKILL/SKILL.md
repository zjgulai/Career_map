---
name: SKILL
trigger: skill, channel, operate/store, health, a
...
> SKILL 是一个专业的 当店铺健康分、ODR 或违规项出现波动时，输出告警分级、修复清单和处理时效建议。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, channel, operate/store, health, a
```
