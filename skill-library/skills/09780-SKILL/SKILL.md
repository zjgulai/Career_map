---
name: SKILL
trigger: skill, supply, chain, fulfill/supplier,
...
> SKILL 是一个专业的 当需要按供应商维度滚动评分、识别高风险供应商并反哺补货与寻源决策时调用；通常月更，可与 PO 到货数据联动。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, supply, chain, fulfill/supplier,
```
