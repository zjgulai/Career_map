...
name: 合同审阅批注与谈判
trigger: 合同审阅批注与谈判
description: **摘要**：本文介绍如何利用 Claude 分析合同条款，识别影响你工作的风险点，并提供修订建议（redlines）和谈判要点。Claude 能像法务团队一样审阅合同，用通俗语言解释条款含义，帮助你
...
> 合同审阅批注与谈判 是一个专业的 **摘要**：本文介绍如何利用 Claude 分析合同条款，识别影响你工作的风险点，并提供修订建议（redlines）和谈判要点。Claude 能像法务团队一样审阅合同，用通俗语言解释条款含义，帮助你，帮助用户快速完成相关任务并输出标准化交付物。
...
合同审阅批注与谈判 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 合同审阅批注与谈判 帮我下一步行动或相关skill推荐...
```
