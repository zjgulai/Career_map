---
name: SKILL
trigger: skill, finance, cost, management/tax, co
...
> SKILL 是一个专业的 当进入新市场或税制发生变化时，基于交易与税率规则输出税务合规差距清单、截止风险与整改建议。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, finance, cost, management/tax, co
```
