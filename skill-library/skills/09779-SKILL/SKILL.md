---
name: SKILL
trigger: skill, supply, chain, fulfill/replenish
...
> SKILL 是一个专业的 当需要按 SKU/站点计算可售天数、预计断货日与预警等级（如 30 天内断货）以驱动需求预测与补货链时调用。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, supply, chain, fulfill/replenish
```
