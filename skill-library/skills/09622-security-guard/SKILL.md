---
name: security-guard
trigger: security, 安全审查, 漏洞扫描, OWASP, 安全审计, 代码安全
description: 安全漏洞审查
category: dev
version: 2.1.0
author: hermes-ai
...
> security-guard 是一个专业的 安全漏洞审查，帮助用户快速完成相关任务并输出标准化交付物。
...
```
security, 安全审查, 漏洞扫描, OWASP, 安全审计, 代码安全
```
...
security-guard 属于 **开发运维** 域（development and DevOps for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 security-guard 帮我下一步行动或相关skill推荐...
```
