---
name: autopilot
trigger: autopilot, 全自动, build me, create, 生成代码, 全自动开发
description: 全自动代码生成
category: dev
version: 2.1.0
author: hermes-ai
...
> autopilot 是一个专业的 全自动代码生成，帮助用户快速完成相关任务并输出标准化交付物。
...
```
autopilot, 全自动, build me, create, 生成代码, 全自动开发
```
...
autopilot 属于 **开发运维** 域（development and DevOps for Momcozy），可与其他 skill 形成工作流链路：

- **code-refactor**: 当本skill输出需要进一步处理时调用
...
```
使用 autopilot 帮我下一步行动或相关skill推荐...
```
