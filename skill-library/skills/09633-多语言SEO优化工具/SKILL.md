---
name: SEO Multilingual - 多语言SEO优化工具
trigger: seo, multilingual, , , 多语言seo优化工具
description: 提供hreflang标签配置、多语言站点架构、地域定向优化、跨境SEO策略等国际化优化方案。
category: lute_cbec
version: 2.1.0
author: hermes-ai
...
> SEO Multilingual - 多语言SEO优化工具 是一个专业的 提供hreflang标签配置、多语言站点架构、地域定向优化、跨境SEO策略等国际化优化方案。，帮助用户快速完成相关任务并输出标准化交付物。
...
SEO Multilingual - 多语言SEO优化工具 属于 **搜索优化** 域（SEO/GEO optimization for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 SEO Multilingual - 多语言SEO优化工具 帮我下一步行动或相关skill推荐...
```
...
```mermaid
graph LR
    A[用户输入] -->|触发词| B(SEO Multilingual - 多语言SEO优化工具)
    B --> C[分析结果]
    B --> D[解决方案]
```
