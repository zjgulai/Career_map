---
name: SKILL
trigger: skill, strategy, insight/strategic, rev
...
> SKILL 是一个专业的 当需要把各职能域关键指标与异常汇总成一份给 CGO/管理层的复盘稿（非执行细项）时调用；建议与 cross-domain-trigger-hub 输出联用。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, strategy, insight/strategic, rev
```
