---
name: SKILL
trigger: skill, supply, chain, fulfill/purchase,
...
> SKILL 是一个专业的 在补货决策已书面/系统批准后，将批次与 SKU 行生成标准采购单（中/英/德等），便于发送供应商与留档；不自动发送除非对接系统。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, supply, chain, fulfill/purchase,
```
