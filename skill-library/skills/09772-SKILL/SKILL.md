---
name: SKILL
trigger: skill, finance, cost, management/unit, e
...
> SKILL 是一个专业的 当需要基于采购成本、物流费用、平台佣金与投放成本测算单 SKU 毛利率、ROI 与回本周期时调用。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, finance, cost, management/unit, e
```
