---
name: SKILL
trigger: skill, strategy, insight/ka, performanc
...
> SKILL 是一个专业的 当需要从 KA 视角汇总 POS 动销、货架效率、库存周转与应收账期健康度，形成可执行改进清单并触发跨域动作时调用；不替代单店动销归因或会计核销。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, strategy, insight/ka, performanc
```
