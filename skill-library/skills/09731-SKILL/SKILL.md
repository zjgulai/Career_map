---
name: SKILL
trigger: skill, operations, execute/platform, fo
...
> SKILL 是一个专业的 当 Listing/A+ 已定稿且需按各平台字段长度、HTML/富文本、变体与媒体槽位导出可粘贴或批量导入片段时调用；不替代各平台后台发布权限与 API 报错排查。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, operations, execute/platform, fo
```
