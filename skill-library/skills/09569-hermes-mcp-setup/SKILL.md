...
trigger: mcp setup, MCP配置, Model Context Protocol, 模型上下文协议, 工具配置
...
> hermes-mcp-setup 是一个专业的 MCP服务器配置，帮助用户快速完成相关任务并输出标准化交付物。
...
```
mcp setup, MCP配置, Model Context Protocol, 模型上下文协议, 工具配置
```
...
hermes-mcp-setup 属于 **开发运维** 域（development and DevOps for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 hermes-mcp-setup 帮我下一步行动或相关skill推荐...
```
