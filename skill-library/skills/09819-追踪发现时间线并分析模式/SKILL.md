---
name: 追踪发现时间线并分析模式
trigger: 追踪发现时间线并分析模式
description: 来源：https://claude.com/resources/use-cases/track-discovery-timelines-and-analyze-patterns
...
> 追踪发现时间线并分析模式 是一个专业的 来源：https://claude.com/resources/use-cases/track-discovery-timelines-and-analyze-patterns，帮助用户快速完成相关任务并输出标准化交付物。
...
追踪发现时间线并分析模式 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 追踪发现时间线并分析模式 帮我下一步行动或相关skill推荐...
```
