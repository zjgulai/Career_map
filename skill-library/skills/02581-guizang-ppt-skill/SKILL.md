...
title: "网页 PPT 制作"
user_summary: "做一份能在浏览器直接翻页的分享 PPT，不用装工具"
user_try: "帮我做一份 15 分钟的分享 PPT，要杂志风"
description: "生成单文件 HTML 的横向翻页 PPT，提供电子杂志风与瑞士国际主义风两套模板。触发词：做个 PPT、网页 PPT、杂志风 PPT、瑞士风、演示文稿、guizang-ppt-skill。何时不用：大段表格与图表叠加的场合不合适；要印刷级 PDF 版面用 minimax-pdf。"
enabled: "true"
user-invocable: true
metadata:
  source: "third-party"
  ...
  sha256: "fa0d0b8f81c90477f652c1a790b6371a82aae788829d6edf6e3c7de64d1e7646"
...
1. 同时打开当前模板或生成页、测试 PPT;如果平台提供原始参考 PPT,也同步打开对照。
