...
name: 为合规审计准备分散文档
trigger: 为合规审计准备分散文档
description: 来源：https://claude.com/resources/use-cases/prep-scattered-documents-for-a-compliance-audit
...
> 为合规审计准备分散文档 是一个专业的 来源：https://claude.com/resources/use-cases/prep-scattered-documents-for-a-compliance-audit，帮助用户快速完成相关任务并输出标准化交付物。
...
为合规审计准备分散文档 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 为合规审计准备分散文档 帮我下一步行动或相关skill推荐...
```
