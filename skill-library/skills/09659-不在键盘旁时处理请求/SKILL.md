...
name: 不在键盘旁时处理请求
trigger: 不在键盘旁时处理请求
description: 来源：https://claude.com/resources/use-cases/handle-a-request-while-away-from-your-keyboard
...
> 不在键盘旁时处理请求 是一个专业的 来源：https://claude.com/resources/use-cases/handle-a-request-while-away-from-your-keyboard，帮助用户快速完成相关任务并输出标准化交付物。
...
不在键盘旁时处理请求 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 不在键盘旁时处理请求 帮我下一步行动或相关skill推荐...
```
