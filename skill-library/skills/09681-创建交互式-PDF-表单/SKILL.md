---
name: 创建交互式 PDF 表单
trigger: 创建交互式, pdf, 表单
description: 来源：https://claude.com/resources/use-cases/create-interactive-pdf-forms
...
> 创建交互式 PDF 表单 是一个专业的 来源：https://claude.com/resources/use-cases/create-interactive-pdf-forms，帮助用户快速完成相关任务并输出标准化交付物。
...
创建交互式 PDF 表单 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 创建交互式 PDF 表单 帮我下一步行动或相关skill推荐...
```
