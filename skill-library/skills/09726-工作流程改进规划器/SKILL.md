...
name: 工作流程改进规划器
trigger: 工作流程改进规划器
description: 来源：https://claude.com/resources/use-cases/workflow-improvement-planner
...
> 工作流程改进规划器 是一个专业的 来源：https://claude.com/resources/use-cases/workflow-improvement-planner，帮助用户快速完成相关任务并输出标准化交付物。
...
工作流程改进规划器 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 工作流程改进规划器 帮我下一步行动或相关skill推荐...
```
