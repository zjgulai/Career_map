---
name: hermes-skillify
trigger: skillify, 固化工作流, make skill, 工作流固化, 流程标准化
description: 工作流固化为Skill
category: meta
version: 2.1.0
author: hermes-ai
...
> hermes-skillify 是一个专业的 工作流固化为Skill，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skillify, 固化工作流, make skill, 工作流固化, 流程标准化
```
...
hermes-skillify 属于 **开发运维** 域（development and DevOps for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 hermes-skillify 帮我下一步行动或相关skill推荐...
```
