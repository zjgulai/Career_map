---
name: SKILL
trigger: skill, product, manage/sku, health, scan
...
> SKILL 是一个专业的 当需要按周/月对大量 SKU 做销量趋势、利润、库存周转、评分等健康度分级（S/A/B/C）并输出货盘周报素材时调用。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, product, manage/sku, health, scan
```
