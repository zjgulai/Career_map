---
name: SKILL
trigger: skill, channel, operate/ka, replenishme
...
> SKILL 是一个专业的 在已有动销与库存分析后，结合 KA 采购周期、最小订单、在途与促销备货需求，生成按 SKU/门店/周的补货建议与风险提示。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, channel, operate/ka, replenishme
```
