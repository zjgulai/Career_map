...
| [`+set-ancestor`](references/lark-ta[REDACTED].md) | set or clear a task ancestor |
...
| [`+get-my-tasks`](references/lark-ta[REDACTED].md) | List tasks assigned to me |
| [`+get-related-tasks`](references/lark-ta[REDACTED].md) | list tasks related to me |
| [`+search`](references/lark-task-search.md) | search tasks |
| [`+upload-attachment`](references/lark-ta[REDACTED].md) | upload a local file as an attachment to a task |
| [`+tasklist-create`](references/lark-ta[REDACTED].md) | create a tasklist and optionally add tasks |
| [`+tasklist-search`](references/lark-ta[REDACTED].md) | search tasklists |
| [`+tasklist-task-add`](references/lark-ta[REDACTED].md) | add tasks to a tasklist |
| [`+tasklist-members`](references/lark-ta[REDACTED].md) | manage tasklist members |
