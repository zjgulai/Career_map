---
name: SKILL
trigger: skill, marketing, promote/tiktok, hook,
...
> SKILL 是一个专业的 当需要为 TikTok/Reels 类短视频生成前 3 秒 Hook 文案与镜头建议（夜奶、背奶、职场哺乳等场景）且已有信任型 brief 时调用；输出需再经品牌调性与 FTC/GDPR 合规门。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, marketing, promote/tiktok, hook,
```
