...
name: 创建健康与运动笔记
trigger: 创建健康与运动笔记
description: 来源：https://claude.com/resources/use-cases/create-health-and-exercise-notes
...
> 创建健康与运动笔记 是一个专业的 来源：https://claude.com/resources/use-cases/create-health-and-exercise-notes，帮助用户快速完成相关任务并输出标准化交付物。
...
创建健康与运动笔记 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 创建健康与运动笔记 帮我下一步行动或相关skill推荐...
```
