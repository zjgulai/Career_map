---
name: hermes-pua
trigger: pua, 高agency, 强制解决, 穷尽方案, 企业级严谨, 高能动性
description: 强制高agency问题解决
category: ai
version: 2.1.0
author: hermes-ai
...
> hermes-pua 是一个专业的 强制高agency问题解决，帮助用户快速完成相关任务并输出标准化交付物。
...
```
pua, 高agency, 强制解决, 穷尽方案, 企业级严谨, 高能动性
```
...
hermes-pua 属于 **开发运维** 域（development and DevOps for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 hermes-pua 帮我下一步行动或相关skill推荐...
```
