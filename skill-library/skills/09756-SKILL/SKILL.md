---
name: SKILL
trigger: skill, customer, care, support/feedback
...
> SKILL 是一个专业的 当需从一段时期内的工单与评价中提炼可结构化洞察（质量问题、包装、说明书、竞品对比）并推送给产品与货盘域时调用。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, customer, care, support/feedback
```
