---
name: hermes-release
trigger: release, 发布, 版本号, CHANGELOG, 发布检查, 版本管理
description: 版本管理与发布准备
category: devops
version: 2.1.0
author: hermes-ai
...
> hermes-release 是一个专业的 版本管理与发布准备，帮助用户快速完成相关任务并输出标准化交付物。
...
```
release, 发布, 版本号, CHANGELOG, 发布检查, 版本管理
```
...
hermes-release 属于 **开发运维** 域（development and DevOps for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 hermes-release 帮我下一步行动或相关skill推荐...
```
