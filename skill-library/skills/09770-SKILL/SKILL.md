---
name: SKILL
trigger: skill, product, manage/assortment, stru
...
> SKILL 是一个专业的 当需要基于 ERP 销售与毛利数据评估 SKU 组合中引流款/利润款/形象款占比、与品类经验区间对比并输出结构调整建议时调用；不替代选品会最终拍板。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, product, manage/assortment, stru
```
