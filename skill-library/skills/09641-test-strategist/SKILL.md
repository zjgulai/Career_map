...
trigger: test, 测试策略, 测试方案, 测试用例, 覆盖率, 边界测试
description: 全面测试方案设计
category: dev
version: 2.1.0
author: hermes-ai
...
> test-strategist 是一个专业的 全面测试方案设计，帮助用户快速完成相关任务并输出标准化交付物。
...
test-strategist 属于 **开发运维** 域（development and DevOps for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 test-strategist 帮我下一步行动或相关skill推荐...
```
