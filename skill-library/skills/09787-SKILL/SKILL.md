---
name: SKILL
trigger: skill, channel, operate/compliance, cal
...
> SKILL 是一个专业的 当需要维护证书/检测报告/DoC 等到期日、并生成 90/60/30 天提醒与复盘任务时调用；适合周例会与供应商/公告机构跟催。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, channel, operate/compliance, cal
```
