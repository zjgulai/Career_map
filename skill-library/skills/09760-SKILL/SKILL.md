---
name: SKILL
trigger: skill, operations, execute/shopify, seo
...
> SKILL 是一个专业的 当需要为 DTC 独立站优化集合页/博客/产品页的 SEO 要素（标题、meta、结构化数据占位、hreflang 思路）并区分北美与欧洲搜索习惯时调用；不替代技术 SEO 爬网与 Core Web Vitals 工程排障。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, operations, execute/shopify, seo
```
...
SKILL 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
