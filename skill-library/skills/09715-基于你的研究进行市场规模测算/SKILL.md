---
name: 基于你的研究进行市场规模测算
trigger: 基于你的研究进行市场规模测算
description: 来源：https://claude.com/resources/use-cases/size-a-market-using-your-research
...
> 基于你的研究进行市场规模测算 是一个专业的 来源：https://claude.com/resources/use-cases/size-a-market-using-your-research，帮助用户快速完成相关任务并输出标准化交付物。
...
基于你的研究进行市场规模测算 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 基于你的研究进行市场规模测算 帮我下一步行动或相关skill推荐...
```
