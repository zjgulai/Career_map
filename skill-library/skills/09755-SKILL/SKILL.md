---
name: SKILL
trigger: skill, channel, operate/ka, jbp, generat
...
> SKILL 是一个专业的 当需与 KA 签署或更新年度 JBP、且财务与动销结论已对齐时调用；输出章节结构与可填表，与 ka-financial-model 数字一致。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, channel, operate/ka, jbp, generat
```
