...
name: 分析用户反馈中的模式
trigger: 分析用户反馈中的模式
description: 来源：https://claude.com/resources/use-cases/analyze-patterns-in-user-feedback
...
> 分析用户反馈中的模式 是一个专业的 来源：https://claude.com/resources/use-cases/analyze-patterns-in-user-feedback，帮助用户快速完成相关任务并输出标准化交付物。
...
分析用户反馈中的模式 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 分析用户反馈中的模式 帮我下一步行动或相关skill推荐...
```
