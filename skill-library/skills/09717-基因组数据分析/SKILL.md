...
name: 基因组数据分析
trigger: 基因组数据分析
description: 来源：https://claude.com/resources/use-cases/genomic-data-analysis
...
> 基因组数据分析 是一个专业的 来源：https://claude.com/resources/use-cases/genomic-data-analysis，帮助用户快速完成相关任务并输出标准化交付物。
...
基因组数据分析 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
