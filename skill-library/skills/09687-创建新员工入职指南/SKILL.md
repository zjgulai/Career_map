...
name: 创建新员工入职指南
trigger: 创建新员工入职指南
description: 来源：https://claude.com/resources/use-cases/create-new-hire-onboarding-guides
...
> 创建新员工入职指南 是一个专业的 来源：https://claude.com/resources/use-cases/create-new-hire-onboarding-guides，帮助用户快速完成相关任务并输出标准化交付物。
...
创建新员工入职指南 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 创建新员工入职指南 帮我下一步行动或相关skill推荐...
```
