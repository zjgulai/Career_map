...
name: 创建志愿者管理系统
trigger: 创建志愿者管理系统
description: **来源：** https://claude.com/resources/use-cases/create-a-volunteer-management-system
...
> 创建志愿者管理系统 是一个专业的 **来源：** https://claude.com/resources/use-cases/create-a-volunteer-management-system，帮助用户快速完成相关任务并输出标准化交付物。
...
创建志愿者管理系统 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 创建志愿者管理系统 帮我下一步行动或相关skill推荐...
```
