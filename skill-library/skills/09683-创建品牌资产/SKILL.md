...
name: 创建品牌资产
trigger: 创建品牌资产
description: **摘要**：本文介绍如何利用 Claude 的图像识别、设计参考处理和代码生成能力，根据你的品牌指南快速生成名片、传单、营销物料等品牌资产。上传品牌指南文档或参考图片，Claude 即可输出符合你视
...
> 创建品牌资产 是一个专业的 **摘要**：本文介绍如何利用 Claude 的图像识别、设计参考处理和代码生成能力，根据你的品牌指南快速生成名片、传单、营销物料等品牌资产。上传品牌指南文档或参考图片，Claude 即可输出符合你视，帮助用户快速完成相关任务并输出标准化交付物。
...
创建品牌资产 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
