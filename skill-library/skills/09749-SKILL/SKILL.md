---
name: SKILL
trigger: skill, customer, care, support/inquiry,
...
> SKILL 是一个专业的 当收到英/德/法/意/西/阿等语言的客服工单或邮件、需先分类与打优先级以便路由时调用；**安全类永远最高优先级**。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, customer, care, support/inquiry,
```
