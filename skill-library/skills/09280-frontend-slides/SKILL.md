...
2. **View each image** — Use the Read tool (Codex is multimodal)
...
Save previews to `.Codex-design/slide-previews/` (style-a.html, style-b.html, style-c.html). Each should be self-contained, ~50-100 lines, showing one animated title slide.
...
1. **Clean up** — Delete `.Codex-design/slide-previews/` if it exists
