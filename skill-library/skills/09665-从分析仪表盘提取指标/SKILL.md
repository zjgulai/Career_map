...
name: 从分析仪表盘提取指标
trigger: 从分析仪表盘提取指标
description: 来源：https://claude.com/resources/use-cases/pull-metrics-from-analytics-dashboards
...
> 从分析仪表盘提取指标 是一个专业的 来源：https://claude.com/resources/use-cases/pull-metrics-from-analytics-dashboards，帮助用户快速完成相关任务并输出标准化交付物。
...
从分析仪表盘提取指标 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 从分析仪表盘提取指标 帮我下一步行动或相关skill推荐...
```
