---
name: SKILL
trigger: skill, product, manage/attribution, ana
...
> SKILL 是一个专业的 当 SKU 处于 B 级预警或生命周期衰退/成熟停滞、需要拆解是流量、转化、客单价还是竞争导致时调用；输出可行动的假设与数据缺口。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, product, manage/attribution, ana
```
