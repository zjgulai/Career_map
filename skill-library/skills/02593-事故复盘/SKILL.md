...
title: "事故复盘"
description: "按六步 SOP 把线上事故写成无责复盘：时间线、5 Whys 根因、SMART 改进措施，输出格式化复盘文档。触发词：事故复盘、incident-retrospective、按六步 SOP 把线上事故写成无责复盘：时间线、5 Whys 根因、SMART 改进措施，输出格式化复盘文档。"
enabled: "true"
disable-model-invocation: false
user-invocable: true
---

# postmortem-writer（事故复盘）
