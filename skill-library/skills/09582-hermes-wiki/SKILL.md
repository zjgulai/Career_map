---
name: hermes-wiki
trigger: wiki, 知识库, 文档管理, knowledge, 知识管理, 项目文档
description: 项目知识库管理
...
> hermes-wiki 是一个专业的 项目知识库管理，帮助用户快速完成相关任务并输出标准化交付物。
...
```
wiki, 知识库, 文档管理, knowledge, 知识管理, 项目文档
```
...
hermes-wiki 属于 **开发运维** 域（development and DevOps for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 hermes-wiki 帮我下一步行动或相关skill推荐...
```
