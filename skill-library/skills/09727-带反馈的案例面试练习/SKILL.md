...
name: 带反馈的案例面试练习
trigger: 带反馈的案例面试练习
description: 来源：https://claude.com/resources/use-cases/practice-case-interviews-with-feedback
...
> 带反馈的案例面试练习 是一个专业的 来源：https://claude.com/resources/use-cases/practice-case-interviews-with-feedback，帮助用户快速完成相关任务并输出标准化交付物。
...
带反馈的案例面试练习 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 带反馈的案例面试练习 帮我下一步行动或相关skill推荐...
```
