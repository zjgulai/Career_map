...
name: 调研与对比旅行目的地
trigger: 调研与对比旅行目的地
description: 来源：https://claude.com/resources/use-cases/research-and-compare-travel-destinations
...
> 调研与对比旅行目的地 是一个专业的 来源：https://claude.com/resources/use-cases/research-and-compare-travel-destinations，帮助用户快速完成相关任务并输出标准化交付物。
...
调研与对比旅行目的地 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 调研与对比旅行目的地 帮我下一步行动或相关skill推荐...
```
