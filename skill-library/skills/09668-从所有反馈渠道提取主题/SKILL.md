...
name: 从所有反馈渠道提取主题
trigger: 从所有反馈渠道提取主题
description: 来源：https://claude.com/resources/use-cases/surface-themes-from-all-your-feedback-channels
...
> 从所有反馈渠道提取主题 是一个专业的 来源：https://claude.com/resources/use-cases/surface-themes-from-all-your-feedback-channels，帮助用户快速完成相关任务并输出标准化交付物。
...
从所有反馈渠道提取主题 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 从所有反馈渠道提取主题 帮我下一步行动或相关skill推荐...
```
