...
```bash
/skill-evaluator /path/to/skill-folder
```
...
```bash
# 方式1: 评估后直接优化
/skill-evaluator /path/to/skill --auto-opt

# 方式2: 先生成报告，再优化
/skill-evaluator /path/to/skill
...
```bash
/skill-evaluator /path/to/skills --batch
/skill-evaluator /path/to/skills --batch --min-score=70
```
