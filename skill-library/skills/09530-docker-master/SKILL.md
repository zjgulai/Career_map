---
name: docker-master
trigger: docker, 容器优化, Dockerfile, 镜像优化, 多阶段构建, 容器化
description: Docker最佳实践
category: devops
version: 2.1.0
author: hermes-ai
...
> docker-master 是一个专业的 Docker最佳实践，帮助用户快速完成相关任务并输出标准化交付物。
...
```
docker, 容器优化, Dockerfile, 镜像优化, 多阶段构建, 容器化
```
...
docker-master 属于 **开发运维** 域（development and DevOps for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 docker-master 帮我下一步行动或相关skill推荐...
```
