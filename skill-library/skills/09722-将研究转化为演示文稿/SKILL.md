...
name: 将研究转化为演示文稿
trigger: 将研究转化为演示文稿
description: 来源：https://claude.com/resources/use-cases/turn-research-into-presentations
...
> 将研究转化为演示文稿 是一个专业的 来源：https://claude.com/resources/use-cases/turn-research-into-presentations，帮助用户快速完成相关任务并输出标准化交付物。
...
将研究转化为演示文稿 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 将研究转化为演示文稿 帮我下一步行动或相关skill推荐...
```
