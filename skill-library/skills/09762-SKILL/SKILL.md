---
name: SKILL
trigger: skill, channel, operate/keyword, matrix
...
> SKILL 是一个专业的 当需要为亚马逊/TikTok/独立站搭建可批量用于 Listing 与广告的三层关键词矩阵时调用；必须指定 market_profile，北美与欧洲不得混表。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, channel, operate/keyword, matrix
```
