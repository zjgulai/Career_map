---
name: hermes-skill
trigger: skill, 技能管理, 创建skill, 更新skill, 删除skill, skill查看
description: Skill创建与管理
category: meta
version: 2.1.0
author: hermes-ai
...
> hermes-skill 是一个专业的 Skill创建与管理，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, 技能管理, 创建skill, 更新skill, 删除skill, skill查看
```
...
hermes-skill 属于 **开发运维** 域（development and DevOps for Momcozy），可与其他 skill 形成工作流链路：

- **hermes-skillify**: 当本skill输出需要进一步处理时调用
...
```
使用 hermes-skill 帮我下一步行动或相关skill推荐...
```
