...
name: 将短信线程转为研究笔记
trigger: 将短信线程转为研究笔记
description: 来源：https://claude.com/resources/use-cases/turn-text-threads-to-researched-notes
...
> 将短信线程转为研究笔记 是一个专业的 来源：https://claude.com/resources/use-cases/turn-text-threads-to-researched-notes，帮助用户快速完成相关任务并输出标准化交付物。
...
将短信线程转为研究笔记 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 将短信线程转为研究笔记 帮我下一步行动或相关skill推荐...
```
