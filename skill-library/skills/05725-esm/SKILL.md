...
# Connect to Forge
model = ESM3ForgeInferenceClient(model="esm3-medium-2024-08", url="https://forge.evolutionaryscale.ai", [REDACTED]")
...
client = ESM3ForgeInferenceClient(model="esm3-medium-2024-08", [REDACTED]")
