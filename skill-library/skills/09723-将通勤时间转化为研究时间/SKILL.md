---
name: 将通勤时间转化为研究时间
trigger: 将通勤时间转化为研究时间
description: **来源：** https://claude.com/resources/use-cases/turn-transit-time-into-research-time
...
> 将通勤时间转化为研究时间 是一个专业的 **来源：** https://claude.com/resources/use-cases/turn-transit-time-into-research-time，帮助用户快速完成相关任务并输出标准化交付物。
...
将通勤时间转化为研究时间 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 将通勤时间转化为研究时间 帮我下一步行动或相关skill推荐...
```
