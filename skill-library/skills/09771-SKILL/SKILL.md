---
name: SKILL
trigger: skill, operations, execute/tiktok, scri
...
> SKILL 是一个专业的 当需要基于 Hook 与产品事实生成整支带货视频的完整脚本（分镜、口播、字幕、必填安全提示位）且将用于 TikTok Shop/信息流投放时调用；须再经 `ftc-gdpr-compliance-checker` 与平台政策。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, operations, execute/tiktok, scri
```
