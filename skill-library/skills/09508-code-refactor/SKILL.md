---
name: code-refactor
trigger: refactor, 重构, 代码坏味道, 改善代码, 代码清理, 重构手法
description: 系统化代码重构
category: dev
version: 2.1.0
author: hermes-ai
...
> code-refactor 是一个专业的 系统化代码重构，帮助用户快速完成相关任务并输出标准化交付物。
...
```
refactor, 重构, 代码坏味道, 改善代码, 代码清理, 重构手法
```
...
code-refactor 属于 **开发运维** 域（development and DevOps for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 code-refactor 帮我下一步行动或相关skill推荐...
```
