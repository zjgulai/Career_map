---
name: SKILL
trigger: skill, marketing, promote/brand, voice,
...
> SKILL 是一个专业的 当需要在发布前检查营销文案/脚本是否符合「专业+温暖+可信赖」母婴调性、并标出语气偏离与夸大风险时调用；不替代法律合规结论。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, marketing, promote/brand, voice,
```
