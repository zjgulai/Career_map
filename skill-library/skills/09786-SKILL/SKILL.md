---
name: SKILL
trigger: skill, product, manage/new, sku, opportu
...
> SKILL 是一个专业的 当需要结合竞品卖点矩阵、价格带与用户评论主题识别货盘空白点并输出可立项的新品方向清单（非具体开模指令）时调用；须与合规与供应链可行性人工确认。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, product, manage/new, sku, opportu
```
