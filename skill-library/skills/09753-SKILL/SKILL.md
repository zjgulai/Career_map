---
name: SKILL
trigger: skill, marketing, promote/creator, affi
...
> SKILL 是一个专业的 当达人联盟计划启动或效率下滑时，基于内容表现与退货数据输出达人分层和佣金优化建议。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, marketing, promote/creator, affi
```
