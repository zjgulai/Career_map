---
name: cbec-logo-designer
trigger: cbec, logo, designer
description: 为 Momcozy 或子品牌设计 Logo，确保在竞品视觉中占据认知空白、提高记忆度和品牌识别。当用户提及"Logo设计"、"品牌标志"、"视觉识别"、"子品牌标志"、"品牌符号"或需要母婴品牌视觉设
category: lute_cbec
version: 2.1.0
author: hermes-ai
...
> cbec-logo-designer 是一个专业的 为 Momcozy 或子品牌设计 Logo，确保在竞品视觉中占据认知空白、提高记忆度和品牌识别。当用户提及"Logo设计"、"品牌标志"、"视觉识别"、"子品牌标志"、"品牌符号"或需要母婴品牌视觉设，帮助用户快速完成相关任务并输出标准化交付物。
...
cbec-logo-designer 属于 **跨境电商** 域（cross-border e-commerce for Momcozy），可与其他 skill 形成工作流链路：

- **Lull**: 当本skill输出需要进一步处理时调用

## 一句话调用

```
使用 cbec-logo-designer 帮我下一步行动或相关skill推荐...
```
...
```mermaid
graph LR
    A[用户输入] -->|触发词| B(cbec-logo-designer)
    B --> C[Lull]
```
