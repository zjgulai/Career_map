---
name: SKILL
trigger: skill, marketing, promote/ad, copy, matr
...
> SKILL 是一个专业的 当需要批量生成可测试的广告标题/正文变体矩阵（搜索/信息流/购物广告等版位）且已有信任型 brief 与关键词种子时调用；须与 NA/EU 分轨并经合规门后投放。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, marketing, promote/ad, copy, matr
```
