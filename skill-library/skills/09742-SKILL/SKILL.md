---
name: SKILL
trigger: skill, customer, care, support/return, d
...
> SKILL 是一个专业的 当工单进入退款/退货阶段、需根据平台规则、成本、库存与用户体验给出可执行方案时调用；输出供客服执行与财务备案。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, customer, care, support/return, d
```
