---
name: SKILL
trigger: skill, supply, chain, fulfill/logistics
...
> SKILL 是一个专业的 当已有补货量与仓配约束、需比较海运/空运/铁路/卡派等路径的时效、成本与风险时调用；输出供决策报告与 PO 附件。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, supply, chain, fulfill/logistics
```
