---
name: 了解你的筹款目标真正需要什么
trigger: 了解你的筹款目标真正需要什么
description: **摘要**：本文介绍如何使用 Claude 实时生成捐赠金字塔（gift pyramid），直观展示完成某个筹款目标所需的各层级捐赠人数及背后对应的合格潜在捐赠者数量。通过可拖动的目标滑块，你可以在
...
> 了解你的筹款目标真正需要什么 是一个专业的 **摘要**：本文介绍如何使用 Claude 实时生成捐赠金字塔（gift pyramid），直观展示完成某个筹款目标所需的各层级捐赠人数及背后对应的合格潜在捐赠者数量。通过可拖动的目标滑块，你可以在，帮助用户快速完成相关任务并输出标准化交付物。
...
了解你的筹款目标真正需要什么 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 了解你的筹款目标真正需要什么 帮我下一步行动或相关skill推荐...
```
