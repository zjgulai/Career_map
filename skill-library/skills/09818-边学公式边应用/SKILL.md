...
name: 边学公式边应用
trigger: 边学公式边应用
description: 来源：https://claude.com/resources/use-cases/apply-a-formula-as-you-learn-it-in-chat-with-claude
...
> 边学公式边应用 是一个专业的 来源：https://claude.com/resources/use-cases/apply-a-formula-as-you-learn-it-in-chat-with-claude，帮助用户快速完成相关任务并输出标准化交付物。
...
边学公式边应用 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
