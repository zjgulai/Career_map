---
name: git-ninja
trigger: git, 版本控制, rebase, cherry-pick, bisect, 分支策略, 提交规范
description: Git高级操作
category: dev
version: 2.1.0
author: hermes-ai
...
> git-ninja 是一个专业的 Git高级操作，帮助用户快速完成相关任务并输出标准化交付物。
...
```
git, 版本控制, rebase, cherry-pick, bisect, 分支策略, 提交规范
```
...
git-ninja 属于 **开发运维** 域（development and DevOps for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 git-ninja 帮我下一步行动或相关skill推荐...
```
