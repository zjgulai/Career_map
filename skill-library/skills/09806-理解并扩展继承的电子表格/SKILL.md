---
name: 理解并扩展继承的电子表格
trigger: 理解并扩展继承的电子表格
description: 来源：https://claude.com/resources/use-cases/understand-and-extend-an-inherited-spreadsheet
...
> 理解并扩展继承的电子表格 是一个专业的 来源：https://claude.com/resources/use-cases/understand-and-extend-an-inherited-spreadsheet，帮助用户快速完成相关任务并输出标准化交付物。
...
理解并扩展继承的电子表格 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 理解并扩展继承的电子表格 帮我下一步行动或相关skill推荐...
```
