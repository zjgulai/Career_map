...
title: "组织架构调研"
description: "- Systematically research a company's organizational structure, build org charts, and create employee profiles per business line. Use when the user asks to \\\"调研组织架构\\\", \\\"org chart\\\", \\\"组织架构图\\\", \\\"员工画像\\\", \\\"业务线/部门结构\\\", or \\\"research [company] team structure and key people\\\"."
triggers: 
  - org structure
...
enabled: "true"
user-invocable: true
workflow: "澄清范围（公司/深度/输出/约束）；公司概览调研；领导层与部门发现；按部门发现员工并建画像；生成组织架构图与报告"
input_contract: 公司名（可选：调研深度、是否要架构图/社交图谱）
output_contract: 报告+架构图：部门、领导层、员工画像，含来源与置信标注
example: 说「调研 Anthropic 的组织架构」→ 得到部门+关键人+架构图报告
...
## 触发词
- 组织架构调研、org-structure-research、调研公司组织架构、汇报关系与员工画像 等表述时使用。

## 何时不用
- 人物背景走 people-research；公司财务画像走 company-research；关系图谱走 social-network-mapper
