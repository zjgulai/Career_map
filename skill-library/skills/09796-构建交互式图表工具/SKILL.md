...
name: 构建交互式图表工具
trigger: 构建交互式图表工具
description: 来源：https://claude.com/resources/use-cases/build-interactive-diagram-tools
...
> 构建交互式图表工具 是一个专业的 来源：https://claude.com/resources/use-cases/build-interactive-diagram-tools，帮助用户快速完成相关任务并输出标准化交付物。
...
构建交互式图表工具 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 构建交互式图表工具 帮我下一步行动或相关skill推荐...
```
