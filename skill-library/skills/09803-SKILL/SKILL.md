---
name: SKILL
trigger: skill, product, manage/weekly, assortme
...
> SKILL 是一个专业的 每周汇总 SKU 健康、利润、动销、退货与库存周转，输出货盘分层与经营动作建议。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, product, manage/weekly, assortme
```
