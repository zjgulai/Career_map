---
name: SKILL
trigger: skill, product, manage/ka, vs, online, as
...
> SKILL 是一个专业的 当需要为同一品牌在线下 KA 与亚马逊/TikTok/独立站之间划分 SKU 组合、包装与定价边界以减少串货与价格冲突时调用；条款与合同须法务与渠道负责人确认。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, product, manage/ka, vs, online, as
```
