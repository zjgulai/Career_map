---
name: SKILL
trigger: skill, finance, cost, management/ka, fin
...
> SKILL 是一个专业的 在提案已有多语言初稿后，对条款组合进行财务建模：毛利率、滚动费用、促销 ROI、账期资金占用；输出供买手谈判与内部审批，属战略（含财务）域。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, finance, cost, management/ka, fin
```
