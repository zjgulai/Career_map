...
name: "minimax-pdf"
title: "排版级 PDF 生成"
user_summary: "把内容排成一份拿得出手的正式 PDF，带封面和版式"
user_try: "把这份 Markdown 报告排成正式 PDF，要封面和目录"
description: "用令牌化设计系统把内容排成印刷级 PDF，含新建、填表单与重排版三条路由与 15 种文档类型。触发词：生成 PDF、做个报告 PDF、填这个表单、排版文档、简历 PDF、minimax-pdf。何时不用：封面渲染依赖 Node 侧 playwright 与 Chromium（正文与表单填写只需 reportlab 与 pypdf）；做网页演示用 guizang-ppt-skill。"
enabled: "true"
user-invocable: true
metadata:
  source: "third-party"
  batch: "minmax"
  license: "MIT"
  sha256: "8b0497ddd27da142deb09b570a56f702f95e5f3f1e192cfe1ae24421416a408d"
