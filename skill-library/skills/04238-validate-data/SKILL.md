...
name: "validate-data"
title: "分析交付前核查"
user_summary: "分析发出去之前先过一遍，把口径、算法和常见陷阱挑出来"
user_try: "这份季度分析要发给管理层，先帮我挑挑毛病"
description: "在分析交付前核查方法论、计算与统计陷阱，给出三级置信度与必须附上的注意事项。触发词：核查分析、数据核对、这结论靠谱吗、交付前检查、挑挑毛病、validate-data。何时不用：要从 Word、PDF、PPT 里提取数据用 sn-da-non-spreadsheet-analysis；Excel 清洗与重算用 sn-da-excel-workflow。"
enabled: "true"
user-invocable: true
metadata:
  source: "third-party"
  ...
  sha256: "1e424822043480375b80aef9416227b1c8083af749ca536568716265f79ca54b"
