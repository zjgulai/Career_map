...
```bash
claude mcp add --transport http render https://mcp.render.com/mcp --header "[REDACTED] <YOUR_API_KEY>"
```
...
- **API Key (CLI)**: `export RENDER_[REDACTED]"` (Get from https://dashboard.render.com/u/*/settings#api-keys)
