---
name: cbec-ai-product-designer
trigger: cbec, ai, product, designer
description: 为 Momcozy 生成围绕真实微时刻、单手交互、隐蔽佩戴的新品概念方案。当用户提及”产品概念设计”、”工业设计方向”、”概念图”、”三档方案”、”产品提案”、”Momcozy新品设计”或需要母婴产品
category: lute_cbec
version: 2.1.0
author: hermes-ai
...
> cbec-ai-product-designer 是一个专业的 为 Momcozy 生成围绕真实微时刻、单手交互、隐蔽佩戴的新品概念方案。当用户提及”产品概念设计”、”工业设计方向”、”概念图”、”三档方案”、”产品提案”、”Momcozy新品设计”或需要母婴产品，帮助用户快速完成相关任务并输出标准化交付物。
...
cbec-ai-product-designer 属于 **跨境电商** 域（cross-border e-commerce for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 cbec-ai-product-designer 帮我下一步行动或相关skill推荐...
```
...
```mermaid
graph LR
    A[用户输入] -->|触发词| B(cbec-ai-product-designer)
    B --> C[分析结果]
    B --> D[解决方案]
```
