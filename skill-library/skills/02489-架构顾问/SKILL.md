...
description: "按工作负载形态给出 ClickHouse 架构决策：摄取、时序分区、富化 join 与预聚合，每条建议标注来源。触发词：ClickHouse 架构设计、clickhouse-architecture-advisor、按工作负载形态给出 ClickHouse 架构决策：摄取、时序分区、富化 join 与预聚合，每条建议标注来源。"
enabled: "true"
