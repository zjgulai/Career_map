...
description: >-
  Check whether a product's economics work: supplier quote or landed cost plus live Amazon prices and fees, with fee scenarios and a GO/CAUTION/NO-GO verdict. Use when the user has a cost or quote.
metadata:
  version: "1.0.0"
---
