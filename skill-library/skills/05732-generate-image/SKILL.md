...
2. Check for `OPENROUTER_[REDACTED]` in the `.env` file
3. If not found, inform the user they need to:
   - Create a `.env` file with `OPENROUTER_[REDACTED]`
   - Or set the environment variable: `export OPENROUTER_[REDACTED]`
