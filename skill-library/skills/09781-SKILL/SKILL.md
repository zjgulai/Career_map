---
name: SKILL
trigger: skill, marketing, promote/content, cale
...
> SKILL 是一个专业的 当需要按北美与欧洲市场分别排布月度或季度内容主题、大促与节日节点（含哺乳周、母亲节等）并输出可执行日历表时调用；不替代具体脚本与合规审阅。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, marketing, promote/content, cale
```
