---
name: i18n-pipeline-integration
trigger: i18n, 国际化, 翻译, 多语言, 本地化, 语言支持
description: 多语言翻译支持
category: dev
version: 2.1.0
author: hermes-ai
...
> i18n-pipeline-integration 是一个专业的 多语言翻译支持，帮助用户快速完成相关任务并输出标准化交付物。
...
i18n-pipeline-integration 属于 **开发运维** 域（development and DevOps for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 i18n-pipeline-integration 帮我下一步行动或相关skill推荐...
```
...
```mermaid
graph LR
    A[用户输入] -->|触发词| B(i18n-pipeline-integration)
    B --> C[分析结果]
    B --> D[解决方案]
```
