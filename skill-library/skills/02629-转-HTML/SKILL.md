...
description: "用 marked、pandoc、gomarkdown 把 Markdown 转成 HTML，或接入 Jekyll、Hugo 模板系统渲染，含配置与安全注意项。触发词：Markdown 转 HTML、markdown-to-html、用 marked、pandoc、gomarkdown 把 Markdown 转成 HTML，或接入 Jekyll、Hugo 模板系统渲染，含配置与安全注意项。"
enabled: "true"
