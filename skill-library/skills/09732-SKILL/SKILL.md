---
name: SKILL
trigger: skill, supply, chain, fulfill/demand, fo
...
> SKILL 是一个专业的 当 replenishment-predictor 判定存在断货风险或需滚动补货量时，结合季节因子、促销计划、新品爬坡生成建议采购/调拨量区间。，帮助用户快速完成相关任务并输出标准化交付物。
...
```
skill, supply, chain, fulfill/demand, fo
```
