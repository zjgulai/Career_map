---
name: 探索Claude能为你做什么
trigger: 探索claude能为你做什么
description: 来源：https://claude.com/resources/use-cases/explore-what-claude-can-do-for-you
...
> 探索Claude能为你做什么 是一个专业的 来源：https://claude.com/resources/use-cases/explore-what-claude-can-do-for-you，帮助用户快速完成相关任务并输出标准化交付物。
...
探索Claude能为你做什么 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
...
```
使用 探索Claude能为你做什么 帮我下一步行动或相关skill推荐...
```
