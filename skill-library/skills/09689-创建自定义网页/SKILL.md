...
name: 创建自定义网页
trigger: 创建自定义网页
description: **摘要**：本文介绍如何利用 Claude 的视觉设计和代码能力，将你的简历、项目描述和设计灵感转化为完整的作品集网站，并指导你无需编写任何代码即可将其部署上线。从 HTML 页面生成到 Netli
...
> 创建自定义网页 是一个专业的 **摘要**：本文介绍如何利用 Claude 的视觉设计和代码能力，将你的简历、项目描述和设计灵感转化为完整的作品集网站，并指导你无需编写任何代码即可将其部署上线。从 HTML 页面生成到 Netli，帮助用户快速完成相关任务并输出标准化交付物。
...
创建自定义网页 属于 **业务运营** 域（business operations for Momcozy），可与其他 skill 形成工作流链路：
